...
src_cur.execute("select id, identifier, description, gn_description, is_choice from base_restrictioncodetype")
...
for src_row in src_cur:
  ...
  try:
    dst_cur.execute("insert into base_restrictioncodetype(id, identifier, description, description_en, gn_description, gn_description_en, is_choice) values (%s, %s, %s, %s, %s, %s, %s)", assignments)
    dst.commit()
  except Exception as error:
    print 
    print type(error)
    print str(error) + "select id, identifier, description, gn_description, is_choice from base_restrictioncodetype"
    print str(src_row)
    dst.rollback()
