...
src_cur.execute("select id, user_id, announcement_id, dismissed_at from announcements_dismissal")
...
for src_row in src_cur:
  ...
  try:
    dst_cur.execute("insert into announcements_dismissal(id, user_id, announcement_id, dismissed_at) values (%s, %s, %s, %s)", assignments)
    dst.commit()
  except Exception as error:
    print 
    print type(error)
    print str(error) + "select id, user_id, announcement_id, dismissed_at from announcements_dismissal"
    print str(src_row)
    dst.rollback()
